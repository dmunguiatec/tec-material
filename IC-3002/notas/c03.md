...
5. Escriba un algoritmo para determinar la moda en una secuencia de enteros. La moda será el número que más se repita en la secuencia. Una secuencia puede tener múltiples modas. Calcule la complejidad temporal y espacial de este algoritmo.
