...
2. Escriba un algoritmo con complejidad temporal $\mathcal{O}(n^2)$ y complejidad espacial $\mathcal{O}(n)$ para determinar si un arreglo de enteros contiene duplicados.

3. Dada una secuencia de enteros, donde cada elemento estará en el rango $[0 \twodots 1000000]$, escriba un algoritmo con complejidad temporal $\mathcal{O}(n)$ para determinar si la secuencia contiene duplicados. ¿Cuál es la complejidad espacial de este algoritmo?

## Apéndice. Números triangulares ##
