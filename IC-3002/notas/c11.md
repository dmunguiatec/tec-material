...
![Buscar $e$ en un arreglo de tamaño 16\label{fig:buscar_paralelo}](plots/buscar_paralelo.png){ width=450px }
...
1. Implemente los ejemplos de *conteo sincronizado* y *prueba de primalida paralela* en un lenguaje de programación que soporte hilos y candados.
