...
Cuando introducimos un segundo hilo con la misma tarea de conteo, la ejecución de las operaciones de modificación del valor de $c$ pueden suceder en un orden intercalado con respecto a $c$, por ejemplo podría suceder una situación como la que se ejemplifica en $\ref{fig:cond_carrera_2}$,
