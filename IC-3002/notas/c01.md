...
5. Determine la complejidad temporal para una función que multiplica dos matrices.

6. Determine la complejidad espacial para una función que multiplica dos matrices.

7. Determine la complejidad temporal para una función que chequea si una lista de números está ordenada ascendentemente.

8. Determine la complejidad espacial para una función que chequea si una lista de números tiene elementos duplicados.

9. Determine la complejidad temporal para una función que encuentra la moda de una lista de números.

10. Determine la complejidad espacial para una función que encuentra la moda de una lista de números.
