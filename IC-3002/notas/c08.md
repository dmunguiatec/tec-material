...
Por tanto para poder decidir utilizar esta técnica, y también para determinar cómo diseñar el algoritmo, primecro es necesario hacer un análisis del problema y determinar cuál es su subestructura óptima (si es que presenta) y cuál es el patrón de repetición de problemas. Esto permitirá determinar cómo memorizar los valores intermedios y cómo utilizarlos en el cálculo de los valores finales.
